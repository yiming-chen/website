...
export default function SectionTeam() {
  ...
  return (
    <div className={classes.section}>
      <h2 className={classes.title}>我们的团队</h2>
      <div>
        <GridContainer>
            ...
            <Card profile plain className={classes.card3}>
              <GridContainer>
                ...
                <GridItem xs={12} sm={7} md={7}>
                  <CardBody plain>
                    <h4 className={classes.cardTitle}>Yiming Chen</h4>
                    <Muted>
          ...
          <GridItem xs={12} sm={6} md={6}>
            <Card profile plain className={classes.card3}>
              <GridContainer>
                ...
                <GridItem xs={12} sm={7} md={7}>
                  <CardBody plain>
                    <h4 className={classes.cardTitle}>Zeng Zitong</h4>
                    <Muted>
          ...
          <GridItem xs={12} sm={6} md={6}>
            <Card profile plain className={classes.card3}>
              <GridContainer>
                ...
                <GridItem xs={12} sm={7} md={7}>
                  <CardBody plain>
                    <h4 className={classes.cardTitle}>Giny </h4>
                    <Muted>
